...
class ItemInfoDtoTest {
    ...
    void testSerialize() throws Exception {
        ...
        assertThat(result).extractingJsonPathNumberValue("$.request")
                .satisfies(request -> assertThat(request.longValue()).isEqualTo(itemInfoDto.getRequest()));
        ...
        assertThat(result).extractingJsonPathNumberValue("$.lastBooking.bookerId")
                .satisfies(request -> assertThat(request.longValue()).isEqualTo(itemInfoDto.getLastBooking().getBookerId()));
        ...
        assertThat(result).extractingJsonPathNumberValue("$.nextBooking.bookerId")
                .satisfies(request -> assertThat(request.longValue()).isEqualTo(itemInfoDto.getNextBooking().getBookerId()));
